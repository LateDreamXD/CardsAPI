...
export default async function handler(req: VercelRequest, res: VercelResponse) {
	...
	<defs>
		<style>
			svg {font-family: system-ui, -apple-system, BlinkMacSystemFont, segoe ui, Roboto, Helvetica, Arial, sans-serif;}
			#bg {color: ${params.bg_color || bgColor}; stroke: ${params.font_color || textColor};}
			#image .line { fill: none; stroke: ${parseInt(params.pic as string) > 3? '#000': 'gray'}; opacity: .7; stroke-miterlimit: 10; stroke-width: 1.5px; stroke-linecap: round; }
	...
	<rect id="bg" x="0" y="0" rx="4" width="500" height="180" fill="currentColor" stroke-width="1" />

	<g id="image">
		<line class="line" x1="250.5" y1="20" x2="250.5" y2="170"/>
		<image class="pic" transform="translate(${250 - (await getPic((params.pic as any) || 1)).offset} 32) scale(0.5)" href="${(await getPic((params.pic as any) || 1)).img}"/>
	</g>
	
	<g id="detail">
		<text class="text" transform="translate(20 35)">🎉 欢迎! o(〃＾▽＾〃)o</text>
		<text class="text" transform="translate(20 65)">📆 今天是 ${moment().format('M')} 月 ${moment().format('D')} 日, ${week[moment().day()]}</text>
